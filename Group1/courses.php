...
<div class="col-lg-6 col-md-6 col-sm-6 col-lg-offset-1 col-md-offset-1 col-sm-offset-1">
	<h2 class="text text-center"><caption>AVAILABLE COURSES </caption></h2>
                        ...
                        <div class="panel panel-default" data-scroll-reveal="enter from the bottom after 0.5s">
                            ...
                            <div id="collapse1" class="panel-collapse collapse" style="height: 0px;">
                                <div class="panel-body">
									...
									<?php //get and display available courses
									$sql = "SELECT * FROM available_courses2018 WHERE courseCode LIKE 'csc1%1'
											OR courseCode LIKE 'csc1%0' ORDER BY courseCode DESC"; //select all courses from the database
									$conn->firstsemester($sql);
									
									$sql = "SELECT * FROM available_courses2018 WHERE courseCode LIKE 'csc1%2'
											OR courseCode LIKE 'csc1%0' ORDER BY courseCode DESC"; //select all courses from the database
											$conn->secondsemester($sql);
									?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default" data-scroll-reveal="enter from the bottom after 0.7s">
                            ...
                            <div id="collapse2" class="panel-collapse collapse" style="height: 0px;">
                                <div class="panel-body">
                                    <div class=" col-md-offset-2 ">
									<?php //get and display available courses
									$sql = "SELECT * FROM available_courses2018 WHERE courseCode LIKE 'csc2%1'
											OR courseCode LIKE 'csc2%0' ORDER BY courseCode DESC"; //select all courses from the database
									$conn->firstsemester($sql);
									
									$sql = "SELECT * FROM available_courses2018 WHERE courseCode LIKE 'csc2%2'
											OR courseCode LIKE 'csc2%0' ORDER BY courseCode DESC"; //select all courses from the database
											$conn->secondsemester($sql);
									?>
                                </div>
                        ...
                        <div class="panel panel-default" data-scroll-reveal="enter from the bottom after 0.9s">
                            ...
                            <div id="collapse3" class="panel-collapse collapse"  style="height: 0px;">
                                <div class="panel-body">
                                    <div class=" col-md-offset-2 ">
									<?php //Get and display available courses
									$sql = "SELECT * FROM available_courses2018 WHERE courseCode LIKE 'csc3%1'
											OR courseCode LIKE 'csc3%0' ORDER BY courseCode DESC"; //select all courses from the database
									$conn->firstsemester($sql);
									
									$sql = "SELECT * FROM available_courses2018 WHERE courseCode LIKE 'csc3%2'
											OR courseCode LIKE 'csc3%0' ORDER BY courseCode DESC"; //select all courses from the database
											$conn->secondsemester($sql);
									?>
									</div>
						...
						<div class="panel panel-default" data-scroll-reveal="enter from the bottom after 1.1s">
                            ...
                            <div id="collapse4" class="panel-collapse collapse" style="height: 0px;">
                                <div class="panel-body">
									...
									<div class=" col-md-offset-2 ">
									<?php //get and display available courses
									$sql = "SELECT * FROM available_courses2018 WHERE courseCode LIKE 'csc4%1'
											OR courseCode LIKE 'csc4%0' ORDER BY courseCode DESC"; //select all courses from the database
									$conn->firstsemester($sql);
									
									$sql = "SELECT * FROM available_courses2018 WHERE courseCode LIKE 'csc4%2'
											OR courseCode LIKE 'csc4%0' ORDER BY courseCode DESC"; //select all courses from the database
											$conn->secondsemester($sql);
									?>
									</div>
